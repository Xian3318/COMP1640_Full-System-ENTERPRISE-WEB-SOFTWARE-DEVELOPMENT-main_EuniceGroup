...
ul {
	...
	<?php 
		...
		?>
                            ...
                            <?php 
                            $query = "SELECT idea.ideaID, idea.ideaTitle,idea.ideaText,react.thumbUp, react.thumbDown FROM idea JOIN managedata ON idea.ideaID = managedata.ideaID JOIN react ON react.reactID = managedata.reactID  WHERE thumbUp=(SELECT MAX(thumbUp) FROM react)";
						...
						<!-- Most thumb Down-->
                            ...
                            <?php 
                            $query = "SELECT idea.ideaID, idea.ideaTitle,idea.ideaText,react.thumbUp, react.thumbDown FROM idea JOIN managedata ON idea.ideaID = managedata.ideaID JOIN react ON react.reactID = managedata.reactID  WHERE thumbDown=(SELECT MAX(thumbDown) FROM react)";
                            $select_department = mysqli_query($conn,$query);
