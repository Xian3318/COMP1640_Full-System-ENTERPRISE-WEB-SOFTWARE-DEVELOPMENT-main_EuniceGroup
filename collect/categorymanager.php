  ...
  <div class="container-fluid">
	...
	<div class="col-xs-6">
                            ...
                            if(isset($_POST['submit'])) {
								...
								$ideaClosureDate= $_POST['ideaClosureDate'];
                                if($categoryName=="" || empty($categoryName)) {
                                    echo " This Field Must Not be Empty";
                                }

                                $query = "INSERT INTO category(categoryName,ideaClosureDate,departmentID) VALUE ('$categoryName', '$ideaClosureDate', '$departmentID')";
                                if($conn->query($query)==TRUE)
								{
                            ...
                            <form action="" method="post">
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    <label for="ideaClosureDate">Idea Closure Date</label>
                                    <input class="form-control" type="text" name="ideaClosureDate">
                                </div>
								 <div class="form-group">
                                    <label for="departmntID">Department ID</label>
